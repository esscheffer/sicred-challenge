...
public class VoteSessionResource {
    ...
    public ResponseEntity<VoteResultApi> voteResult(@PathVariable Long id) {
        return ResponseEntity.status(HttpStatus.CREATED).body(voteSessionService.calculateVotesResult(id));
    }
}
